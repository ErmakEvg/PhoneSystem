...
<body>
    ...
    <div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
        <ul class="nav menu">
            ...
            <li class="active"><a href="PhoneSystemServlet?action=getservices"><svg class="glyph stroked table"><use xlink:href="#stroked-table"></use></svg> ${manager.getString("main-page-nav-link3")}</a></li>
                            ...
                            <tbody>                        
                                <c:forEach var="service" items="${services}">
                                    <tr>
                                        ...
                                        <td>
                                            <a href="PhoneSystemServlet?action=detailservice&id=${service.getId()}"><span title="${manager.getString("services-page-table-span1")}" style="font-size:19px;padding-left: 7px;" class="glyphicon glyphicon-edit" aria-hidden="true"></span></a>
                                            <a href="PhoneSystemServlet?action=deleteservice&id=${service.getId()}"><span title="${manager.getString("services-page-table-span2")}" style="font-size:19px;padding-left: 7px; color:red" class="glyphicon glyphicon-remove-circle" aria-hidden="true"></span></a>
                                        </td>
                                    </tr>
                                </c:forEach>
                            </tbody>
